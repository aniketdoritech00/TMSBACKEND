...
@Configuration
@EnableJpaRepositories(basePackages = "com.doritech.tmsservice.erp.repository", entityManagerFactoryRef = "erpEntityManagerFactory", transactionManagerRef = "erpTransactionManager")
public class ErpDatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean erpEntityManagerFactory(
		...
		// ERP entities
		emf.setPackagesToScan("com.doritech.tmsservice.erp.entity");

		emf.setPersistenceUnitName("erp");
